...
We build our custom Keycloak image with necessary providers in [Aam-Digital/keycloak-aam](https://github.com/Aam-Digital/keycloak-aam/blob/main/Dockerfile).
